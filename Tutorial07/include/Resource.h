 ...
 * No modifiques los valores salvo que también actualices el `.rc`.
 *
...
/** @name Iconos */
/** @{ */
#define IDI_TUTORIAL1           107   /**< @brief Icono principal de la aplicación. */
#define IDI_SMALL               108   /**< @brief Icono alternativo (tamaño pequeño). */
/** @} */
...
#define IDC_STATIC              -1    /**< @brief ID reservado para controles estáticos (Windows). */
/** @} */
...
#define _APS_NEXT_COMMAND_VALUE     32771 /**< @brief Próximo ID de comando de menú. */
#define _APS_NEXT_CONTROL_VALUE     1000  /**< @brief Próximo ID de control. */
#define _APS_NEXT_SYMED_VALUE       110   /**< @brief Próximo ID symed. */
/** @} */
