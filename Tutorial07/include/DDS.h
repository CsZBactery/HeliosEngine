...
//--------------------------------------------------------------------------------------
// DDS.h  (versión ajustada para compilar sin pch)
//--------------------------------------------------------------------------------------

#include <cstdint>
#include <dxgiformat.h>   // <-- Necesario para DXGI_FORMAT en DDS_HEADER_DXT10 / XBOX
...
#define DDSGLOBALCONST extern const __declspec(selectany)
  ...
  // D3DFMT_A2R10G10B10/D3DFMT_A2B10G10R10 should be written using DX10 extension
  ...
  // Legacy D3D9 mixed signed/unsigned formats
  ...
  // Indicates DDS_HEADER_DXT10 extension present
...
#define DDS_FLAGS_VOLUME 0x00200000 // DDSCAPS2_VOLUME
  ...
  // Subset matches D3D10/D3D11 resource dimensions
  ...
  // Subset matches D3D10/D3D11 misc flags
...
#pragma pack(pop)
  ...
  constexpr size_t DDS_XBOX_HEADER_SIZE =
    sizeof(uint32_t) + sizeof(DirectX::DDS_HEADER) + sizeof(DDS_HEADER_XBOX);
