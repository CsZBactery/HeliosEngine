 ...
 * * El Swap Chain es el puente crítico entre la GPU y la ventana de Windows. Administra:
...
public:
	 ...
	 * * Envía el contenido renderizado al monitor y sincroniza con el refresco vertical (V-Sync).
	 */
	void
		present();
