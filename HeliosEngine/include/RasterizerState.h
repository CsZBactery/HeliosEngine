...
public:
	 ...
	 * @param FillMode Modo de relleno de los polígonos (ej. D3D11_FILL_SOLID o D3D11_FILL_WIREFRAME).
	 * @param CullMode Modo de descarte de caras (ej. D3D11_CULL_NONE, D3D11_CULL_FRONT, D3D11_CULL_BACK).
	 * @return @c S_OK si la creación fue exitosa; código @c HRESULT en caso de error.
	 */
	HRESULT
