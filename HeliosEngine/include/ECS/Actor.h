/**
 * @file Actor.h
 * @brief Definición de la entidad principal de renderizado del motor.
 */
 ...
 *
 * @details Un Actor es una entidad del motor que contiene mallas, texturas y recursos de renderizado
...
public:
	 ...
	 *
	 * @details Método heredado de @c Entity.
	 ...
	 *
	 * @details Configura estados de render, buffers y shaders antes de dibujar las mallas asociadas al actor.
	 *
	 * @param deviceContext Contexto del dispositivo para operaciones gráficas.
	 */
	void
	...
	/**
	 * @brief Renderizado especializado para el entorno del mundo.
	 * * @details Se utiliza específicamente para dibujar mallas como el Skybox, asegurando
	 * que no se apliquen transformaciones de traslación ni afecten al buffer de profundidad regular.
	 * * @param deviceContext Contexto del dispositivo para operaciones gráficas.
	 */
	void
	 ...
	 *
	 * @details Incluye buffers, estados, shaders y texturas asociados internamente.
	 */
	void
		destroy();
	 ...
	 *
	 * @details Inicializa buffers de vértices e índices asociados a las mallas.
	 *
	 ...
	 *
	 * @details Usa shaders y estados específicos de shadow mapping para dibujar la proyección del actor en el mapa de sombras.
	 *
	 * @param deviceContext Contexto del dispositivo para operaciones gráficas.
	 */
	void
