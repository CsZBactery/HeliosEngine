...
// -----------------------------------------------------------------------------
// ESTA ES LA PIEZA QUE FALTABA (init)
// -----------------------------------------------------------------------------
// Es necesaria para que el Linker encuentre la función llamada desde BaseApp.
// Inicializamos a nullptr porque BaseApp obtiene el contexto real manualmente.
void DeviceContext::init() {
	m_deviceContext = nullptr;
}

// -----------------------------------------------------------------------------
// TUS FUNCIONES ORIGINALES (CONSERVADAS)
// -----------------------------------------------------------------------------
...
DeviceContext::destroy() {
	if (m_deviceContext) {
		m_deviceContext->ClearState(); // Buena práctica: limpiar estado antes de liberar
